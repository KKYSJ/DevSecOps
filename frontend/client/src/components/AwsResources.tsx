        ...
        <div className="space-y-6">
            ...
            <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
                <div className="border-b border-border px-5 py-4">
                    <div className="text-sm font-semibold text-foreground">우선 확인이 필요한 자산</div>
                    <div className="mt-1 text-xs text-muted-foreground">
                        경고/위험 상태 또는 파생 리스크가 존재하는 리소스를 우선 정렬
                    </div>
                </div>
            ...
            <div className="rounded-xl border border-border bg-card shadow-sm overflow-hidden">
                <div className="border-b border-border px-5 py-4 flex items-center justify-between gap-3">
                    <div>
                        <div className="text-sm font-semibold text-foreground">전체 리소스 인벤토리</div>
                        <div className="mt-1 text-xs text-muted-foreground">
                            리소스별 주요 속성, 파생 리스크, 임시 ISMS 점수 표시
                        </div>
                    </div>
                            ...
                            {resources.map((resource) => {
                                ...
                                return (
                                    ...
                                    >
                                        <td className="px-5 py-4 font-semibold text-foreground">{resource.name}</td>
                                        <td className="px-5 py-4 text-muted-foreground">{resource.type}</td>
                                        <td className="px-5 py-4 text-muted-foreground">{isms.checks}개</td>
                                        <td className="px-5 py-4 font-semibold text-emerald-600">{isms.passed}</td>
                                        <td className="px-5 py-4 font-semibold text-red-500">{isms.failed}</td>
                                        <td className="px-5 py-4 font-semibold text-violet-600">{isms.score}%</td>
                                    </tr>
                                );
                            })}
                        </tbody>
